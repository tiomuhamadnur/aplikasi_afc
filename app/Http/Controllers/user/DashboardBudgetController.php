...
class DashboardBudgetController extends Controller
{
    public function index()
    {
        ...
        $balance = $balance_total->sum('balance');
        ...
        $remaining_balance = $balance - $used_balance;
        ...
        $seriesOpex = [
            ...
            ['Proyeksi', 0],
            ['Sisa', $balance_opex - ($getSumOpex("Realisasi Pembayaran") + $getSumOpex("Realisasi Kegiatan"))]
        ];
        ...
        $seriesCapex = [
            ...
            ['Proyeksi', 0],
            ['Sisa', $balance_capex - ($getSumCapex("Realisasi Pembayaran") + $getSumCapex("Realisasi Kegiatan"))]
        ];
        ...
        foreach ($departments as $department) {
            ...
            $seriesData['Proyeksi'][] = 0;
            $seriesData['Sisa'][] = $total - ($kegiatan + $pembayaran);
        }
        ...
        // TIAP FUND
        $fund_source = BudgetAbsorption::whereRelation('project.fund_source.fund.divisi', 'id', '=', $divisi_id)
                    ->whereRelation('project.fund_source', 'start_period', '<=', $hari_ini)
                    ->whereRelation('project.fund_source', 'end_period', '>=', $hari_ini)
                    ->get();
        ...
        $realisasiKegiatan = [];
        $realisasiPembayaran = [];
        $proyeksi = []; // Placeholder untuk proyeksi
        $sisa = [];
        ...
        foreach ($funds as $fund) {
            ...
            // Placeholder untuk proyeksi
            $proyeksi[] = 0; // Sesuaikan logika jika ada
        }
        ...
        return view('pages.user.dashboard-budgeting.index', [
            ...
            'series' => $series,
            'balance' => RupiahFormat::currency($balance),
