                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="btn-group my-2">
                            ...
                            <button type="button" title="Import Log" class="btn btn-outline-primary btn-rounded btn-icon"
    ...
    <div class="modal fade" id="importLogModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" form="importLogForm" class="btn btn-gradient-primary me-2">Submit</button>
                </div>
            </div>
        </div>
    </div>
