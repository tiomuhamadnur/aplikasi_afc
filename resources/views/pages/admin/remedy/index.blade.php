    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Data Remedy</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="{{ route('remedy.store') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('POST')
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="{{ route('remedy.update') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('PUT')
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="importForm" action="{{ route('remedy.import') }}" method="POST" class="forms-sample"
                        ...
                        <div class="form-group">
                            <label for="">
                                File Import
                                <span>
                                    <a href="{{ asset('assets/format/Template Format Import Remedy.xlsx') }}">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="deleteForm" action="{{ route('remedy.delete') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('delete')
