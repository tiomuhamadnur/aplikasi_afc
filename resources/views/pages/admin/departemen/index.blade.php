        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="{{ route('departemen.store') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('POST')
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="{{ route('departemen.update') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('PUT')
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="deleteForm" action="{{ route('departemen.delete') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('delete')
