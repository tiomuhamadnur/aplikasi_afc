...
@section('title-head')
    <title>Admin | Status Budgeting</title>
@endsection
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Data Status Budgeting</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="{{ route('status-budgeting.store') }}" method="POST" class="forms-sample">
                        @csrf
                        @method('POST')
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="{{ route('status-budgeting.update') }}" method="POST"
                        class="forms-sample">
                        @csrf
                        @method('PUT')
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="deleteForm" action="{{ route('status-budgeting.delete') }}" method="POST"
                        class="forms-sample">
                        @csrf
                        @method('delete')
