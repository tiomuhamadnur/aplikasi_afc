                    ...
                    <form id="addForm" action="{{ route('ini-file.store') }}" method="POST" class="forms-sample">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="station_id" id="station_id">
                                ...
                                <option value="105">FTM</option>
                                <option value="109">CPR</option>
                                <option value="113">HJN</option>
                                <option value="117">BLA</option>
                                <option value="121">BLM</option>
                                <option value="125">ASN</option>
                                <option value="129">SNY</option>
                                <option value="133">IST</option>
                                <option value="137">BNH</option>
                                <option value="141">STB</option>
                                <option value="145">DKA</option>
                                <option value="149">BHI</option>
                            </select>
                        </div>
                        <div class="form-group">
