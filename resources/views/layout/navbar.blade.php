<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ route('dashboard.index') }}"><img style="height: 40px"
                src="{{ asset('assets/images/logo.png') }}" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard.index') }}"><img style="height: 40px; width:40px"
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                        <i class="mdi mdi-key me-2 text-warning"></i> Change Password
                    </a>
                    <div class="dropdown-divider"></div>
